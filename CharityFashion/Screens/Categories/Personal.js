...
const Personal = () => {
  ...
  const [products, setProducts] = useState([
    ...
    { 
      ...
      image: 'https://images.unsplash.com/photo-1587033411394-081a31f106b1?w=500&auto=format&fit=crop'
    },
    { 
      id: 4, 
      name: 'Tracksuits and Sports Wear', 
      price: 89.99, 
    ...
    { 
      id: 5, 
      name: 'Printing and Embroidery Services', 
      price: 24.99, 
      description: 'Shockproof case with built-in screen protector',
